export const handbookData = {
  ...
  postgresql: {
    ...
    highlights: [
      {label: 'SQL & modelling', title: 'Querying, constraints & schema design', description: 'Build strong relational models, write expressive SQL, enforce invariants, and choose data types and constraints deliberately.', href: '/docs/postgresql/sql-foundations/core-sql'},
      {label: 'Performance', title: 'Indexes, EXPLAIN, MVCC & storage', description: 'Reason about index design, planner choices, transaction visibility, vacuum, buffers, locks, and production query performance.', href: '/docs/postgresql/performance/explain-query-planning'},
      {label: 'Production', title: 'WAL, recovery, HA & architecture', description: 'Operate PostgreSQL through backups, recovery, replication, security, observability, failure handling, scaling, and architecture trade-offs.', href: '/docs/postgresql/operations/replication-ha'},
    ],

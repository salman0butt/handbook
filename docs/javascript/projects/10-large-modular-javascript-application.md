---
title: Project 10 — Large Modular JavaScript Application
...
id: 10-large-modular-javascript-application
---

# Project 10 — Large Modular JavaScript Application

**Goal.** Design domain modules, API client, state ownership, DOM UI, async workflows, validation, errors, tests, performance, security, and architecture boundaries.
...
### Architecture
Dependencies point inward; host/platform adapters do not own domain policy.

```text
host adapters → application use cases → domain → explicit outputs
```

**Suggested module structure:** `src/domain/, src/features/, src/platform/, src/ui/, test/`

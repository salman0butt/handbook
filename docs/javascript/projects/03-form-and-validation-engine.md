---
title: Project 3 — Form and Validation Engine
...
id: 03-form-and-validation-engine
---

# Project 3 — Form and Validation Engine


**Goal.** Create composable validation rules, custom errors, DOM form integration, accessibility feedback, and serialization.
...
### Architecture
Parse at the trust boundary; keep validation rules pure and UI reporting separate.

```text
raw form data → parse/validate → typed-by-contract data → submit
```

**Suggested module structure:** `src/rules.js, src/schema.js, src/validate.js, src/dom-adapter.js`

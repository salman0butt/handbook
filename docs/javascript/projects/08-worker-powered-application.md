---
title: Project 8 — Worker-Powered Application
...
id: 08-worker-powered-application
---

# Project 8 — Worker-Powered Application

**Goal.** Move CPU-heavy processing to Web Workers using messages, structured cloning, transferable data, error handling, and performance measurements.
...
### Architecture
Treat worker messaging as a protocol; transfer large buffers when ownership can move.

```text
main thread ⇄ message protocol ⇄ worker CPU
```

**Suggested module structure:** `src/main.js, src/worker.js, src/protocol.js, src/measure.js`

---
title: Project 6 — Event System / Pub-Sub Library
...
id: 06-event-system-pub-sub-library
---

# Project 6 — Event System / Pub-Sub Library

**Goal.** Implement subscribe, unsubscribe, once, async handlers, failure isolation, cleanup, tests, and compare with EventTarget.
...
### Architecture
Subscription lifetime is explicit; emitting must define ordering and error behavior.

```text
publisher → topic → subscriber set → handlers
```

**Suggested module structure:** `src/emitter.js, src/subscription.js, src/errors.js`

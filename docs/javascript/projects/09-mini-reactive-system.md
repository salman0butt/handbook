---
title: Project 9 — Mini Reactive System
...
id: 09-mini-reactive-system
---

# Project 9 — Mini Reactive System

**Goal.** Build dependency tracking with Proxy, effects, scheduling, batching, cleanup, and computed-style derivation.
...
### Architecture
Track reads, trigger writes, schedule effects, and prevent stale subscriptions.

```text
read → track dependency
write → trigger → scheduler → effect
```

**Suggested module structure:** `src/reactive.js, src/effect.js, src/scheduler.js, src/cleanup.js`

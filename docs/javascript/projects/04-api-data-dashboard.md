---
title: Project 4 — API Data Dashboard
...
id: 04-api-data-dashboard
---

# Project 4 — API Data Dashboard

**Goal.** Build a dashboard with fetch, async/await, concurrency, loading/error states, cancellation, rendering, and cache concepts.
...
### Architecture
Separate transport, parsing, query orchestration, and rendering; make stale responses harmless.

```text
UI intent → request → validation → state → render
```

**Suggested module structure:** `src/http.js, src/queries.js, src/state.js, src/view.js`

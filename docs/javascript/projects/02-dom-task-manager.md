---
title: Project 2 — DOM Task Manager
...
id: 02-dom-task-manager
---

# Project 2 — DOM Task Manager


**Goal.** Build an accessible task manager using DOM APIs, events, forms, state, modules, and storage.
...
### Architecture
Keep state separate from DOM nodes; render from state and delegate events.

```text
user event → application state → render → browser DOM
```

**Suggested module structure:** `src/state.js, src/render.js, src/events.js, src/storage.js, src/main.js`

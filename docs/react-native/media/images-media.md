---
title: Images, Media and Assets
description: Optimize images, fonts, SVG, audio, video, compression, upload, memory and platform asset catalogs.
---

# Images, Media and Assets

Optimize images, fonts, SVG, audio, video, compression, upload, memory and platform asset catalogs. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

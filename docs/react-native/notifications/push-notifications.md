...
description: Design APNs and FCM registration, foreground/background handling, channels, categories, deep links and token cleanup.
---

# Push Notifications

Design APNs and FCM registration, foreground/background handling, channels, categories, deep links and token cleanup. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

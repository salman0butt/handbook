...
description: Separate local, server, global, persistent, navigation, form and native state with explicit ownership.
---

# State Management

Separate local, server, global, persistent, navigation, form and native state with explicit ownership. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

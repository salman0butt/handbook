---
title: Persistence and Offline-First Architecture
description: Choose AsyncStorage, secure storage, SQLite, files or databases and design migrations, queues and conflict resolution.
---

# Persistence and Offline-First Architecture

Choose AsyncStorage, secure storage, SQLite, files or databases and design migrations, queues and conflict resolution. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

...
description: Choose core Animated or library-specific UI-thread systems, compose gestures and respect reduced motion.
---

# Animations and Gestures

Choose core Animated or library-specific UI-thread systems, compose gestures and respect reduced motion. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

...
description: Integrate camera, files, location, maps, contacts, haptics, biometrics, sensors, audio and video safely.
---

# Native Device Capabilities

Integrate camera, files, location, maps, contacts, haptics, biometrics, sensors, audio and video safely. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

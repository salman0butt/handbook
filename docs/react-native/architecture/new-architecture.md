...
description: Understand Hermes, JSI, Fabric, TurboModules, Codegen, shadow trees, Yoga, rendering and thread boundaries.
---

# React Native New Architecture

Understand Hermes, JSI, Fabric, TurboModules, Codegen, shadow trees, Yoga, rendering and thread boundaries. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

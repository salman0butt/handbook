---
title: User Input and Production Forms
description: Handle focus, keyboards, validation, autofill, async/server errors, duplicate submission and offline form work.
---

# User Input and Production Forms

Handle focus, keyboards, validation, autofill, async/server errors, duplicate submission and offline form work. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

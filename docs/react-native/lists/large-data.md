---
title: Lists and Large Data
description: Choose ScrollView, FlatList, SectionList or library-specific alternatives and measure virtualization behavior.
---

# Lists and Large Data

Choose ScrollView, FlatList, SectionList or library-specific alternatives and measure virtualization behavior. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

...
description: Use release notes and template diffs, check native dependencies, test upgrade branches and avoid long-term version drift.
---

# Upgrading React Native

Use release notes and template diffs, check native dependencies, test upgrade branches and avoid long-term version drift. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

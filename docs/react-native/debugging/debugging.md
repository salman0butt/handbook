...
description: Use DevTools, Metro logs, Logcat, Xcode, source maps, release artifacts and minimal reproductions systematically.
---

# Debugging React Native

Use DevTools, Metro logs, Logcat, Xcode, source maps, release artifacts and minimal reproductions systematically. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

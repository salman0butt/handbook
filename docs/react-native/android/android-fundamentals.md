...
description: Own Kotlin interop, activities, application lifecycle, Gradle, manifests, resources, variants, R8, signing and Logcat.
---

# Native Android Fundamentals

Own Kotlin interop, activities, application lifecycle, Gradle, manifests, resources, variants, R8, signing and Logcat. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

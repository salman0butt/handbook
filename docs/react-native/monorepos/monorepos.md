---
title: Monorepos and Shared Packages
description: Configure workspaces, Metro, Babel, pods and Gradle while avoiding duplicate React and unsafe native sharing.
---

# Monorepos and Shared Packages

Configure workspaces, Metro, Babel, pods and Gradle while avoiding duplicate React and unsafe native sharing. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

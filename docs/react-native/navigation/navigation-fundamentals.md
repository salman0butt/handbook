...
description: Design typed stacks, tabs, auth/onboarding flows, deep links, restoration and notification routing.
---

# Navigation and Application Flow

Design typed stacks, tabs, auth/onboarding flows, deep links, restoration and notification routing. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

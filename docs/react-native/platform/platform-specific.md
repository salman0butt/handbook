...
description: Use Platform APIs, platform files and native configuration while sharing stable application logic.
---

# Platform-Specific Development

Use Platform APIs, platform files and native configuration while sharing stable application logic. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

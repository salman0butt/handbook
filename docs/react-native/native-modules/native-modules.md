...
description: Build typed TurboModules and Fabric components with Codegen, events, threading, lifecycle and cross-platform tests.
---

# Native Modules and Native Components

Build typed TurboModules and Fabric components with Codegen, events, threading, lifecycle and cross-platform tests. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

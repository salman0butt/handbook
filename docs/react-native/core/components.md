---
title: Core Components and Rendering
description: Use host components, composition, controlled input, reconciliation and native view creation correctly.
---

# Core Components and Rendering

Use host components, composition, controlled input, reconciliation and native view creation correctly. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

...
description: Apply hooks to native subscriptions, lifecycle, keyboard, dimensions, navigation and performance without stale closures.
---

# React Hooks in React Native

Apply hooks to native subscriptions, lifecycle, keyboard, dimensions, navigation and performance without stale closures. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

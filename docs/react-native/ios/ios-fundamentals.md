...
description: Own Swift interop, delegates, targets, schemes, capabilities, entitlements, pods, signing, archives and crash logs.
---

# Native iOS Fundamentals

Own Swift interop, delegates, targets, schemes, capabilities, entitlements, pods, signing, archives and crash logs. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

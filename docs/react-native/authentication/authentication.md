...
description: Implement OAuth 2.0 and OpenID Connect with PKCE, browser callbacks, secure storage, refresh, revocation and biometric unlock.
---

# Mobile Authentication

Implement OAuth 2.0 and OpenID Connect with PKCE, browser callbacks, secure storage, refresh, revocation and biometric unlock. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

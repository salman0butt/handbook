...
description: Support locale detection, language switching, RTL, pluralization, formats, native strings and store metadata.
---

# Internationalization and Localization

Support locale detection, language switching, RTL, pluralization, formats, native strings and store metadata. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

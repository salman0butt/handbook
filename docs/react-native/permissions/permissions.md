---
title: Permissions and Privacy UX
description: Model Android and iOS permission declarations, runtime statuses, denied and blocked recovery, settings and policy.
---

# Permissions and Privacy UX

Model Android and iOS permission declarations, runtime statuses, denied and blocked recovery, settings and policy. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

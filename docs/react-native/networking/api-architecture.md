---
title: Networking and API Architecture
description: Implement cancellation, timeouts, retries, auth refresh, pagination, uploads, offline behavior and normalized errors.
---

# Networking and API Architecture

Implement cancellation, timeouts, retries, auth refresh, pagination, uploads, offline behavior and normalized errors. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

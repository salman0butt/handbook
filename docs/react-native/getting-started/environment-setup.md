...
description: Install and verify Android Studio, SDK tools, JDK 17, Xcode, simulators, CocoaPods and physical devices.
---

# Environment Setup

Install and verify Android Studio, SDK tools, JDK 17, Xcode, simulators, CocoaPods and physical devices. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

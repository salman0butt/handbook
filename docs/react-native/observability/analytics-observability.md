...
description: Define schemas, consent, navigation events, crash symbols, source maps, performance traces, versions and redaction.
---

# Analytics and Observability

Define schemas, consent, navigation events, crash symbols, source maps, performance traces, versions and redaction. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

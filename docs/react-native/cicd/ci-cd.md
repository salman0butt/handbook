...
description: Create reproducible Android and iOS pipelines with caches, tests, signing secrets, artifacts and staged distribution.
---

# Continuous Integration and Delivery

Create reproducible Android and iOS pipelines with caches, tests, signing secrets, artifacts and staged distribution. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

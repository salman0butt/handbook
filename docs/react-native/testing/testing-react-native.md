...
description: Combine Jest, React Native Testing Library, native mocks, integration tests, E2E tests and device coverage.
---

# Testing React Native Applications

Combine Jest, React Native Testing Library, native mocks, integration tests, E2E tests and device coverage. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

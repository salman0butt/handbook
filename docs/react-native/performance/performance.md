...
description: Measure startup, rendering, lists, images, animations, JavaScript/UI work, memory and application size in release builds.
---

# React Native Performance

Measure startup, rendering, lists, images, animations, JavaScript/UI work, memory and application size in release builds. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

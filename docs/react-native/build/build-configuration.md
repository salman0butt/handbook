...
description: Manage Android variants and signing plus iOS schemes, configurations, identifiers, capabilities and environments.
---

# Build Configuration

Manage Android variants and signing plus iOS schemes, configurations, identifiers, capabilities and environments. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

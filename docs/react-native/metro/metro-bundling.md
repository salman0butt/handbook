---
title: Metro and Bundling
description: Understand resolution, Babel transforms, assets, cache, monorepos, source maps, release bundles and Hermes bytecode.
---

# Metro and Bundling

Understand resolution, Babel transforms, assets, cache, monorepos, source maps, release bundles and Hermes bytecode. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

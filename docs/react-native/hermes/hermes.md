...
description: Understand bytecode, startup, memory, garbage collection, Inspector, source maps and browser compatibility differences.
---

# Hermes Runtime

Understand bytecode, startup, memory, garbage collection, Inspector, source maps and browser compatibility differences. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

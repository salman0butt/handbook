---
title: Accessibility
description: Design labels, roles, states, focus, dynamic text, touch targets, reduced motion and screen-reader journeys on both platforms.
---

# Accessibility

Design labels, roles, states, focus, dynamic text, touch targets, reduced motion and screen-reader journeys on both platforms. This page is a canonical production guide for the React Native 0.86 Community CLI baseline. It separates React Native framework behavior, third-party library behavior and Android/iOS platform ownership so version-specific configuration remains visible.

...
# LangChain Packages & Provider Integrations
...
# Chains: Deterministic Composition
...
# `createAgent`: The Modern High-Level Agent API
...
# When to Use LangChain vs Plain SDK vs LangGraph

---
title: "Managed PostgreSQL Services"
description: "Managed services automate parts of operations but keep SQL, transactions, locks and workload design in your ownership. Provider capabilities are not universal PostgreSQL behavior."
---
...
Managed services automate parts of operations but keep SQL, transactions, locks and workload design in your ownership. Provider capabilities are not universal PostgreSQL behavior.
...
- **Amazon** — Amazon RDS and Aurora PostgreSQL-Compatible; connect the feature to correctness, execution cost, concurrency and operations.
- **Google** — Google Cloud SQL; connect the feature to correctness, execution cost, concurrency and operations.
- **Azure** — Azure Database for PostgreSQL; connect the feature to correctness, execution cost, concurrency and operations.
- **Supabase** — Supabase and Neon; connect the feature to correctness, execution cost, concurrency and operations.
- **Railway** — Railway and Render; connect the feature to correctness, execution cost, concurrency and operations.
- **Crunchy** — Crunchy Bridge and DigitalOcean; connect the feature to correctness, execution cost, concurrency and operations.
- **Extensions** — extensions and superuser limitations; connect the feature to correctness, execution cost, concurrency and operations.
- **Backups,** — backups, replicas and failover; connect the feature to correctness, execution cost, concurrency and operations.
- **Pooling,** — pooling, networking and observability; connect the feature to correctness, execution cost, concurrency and operations.
- **Pricing,** — pricing, portability and lock-in; connect the feature to correctness, execution cost, concurrency and operations.

## Practical example

```text
Portable layer:
schema + SQL + constraints + application protocol

Provider layer:
networking + backups + failover + metrics + extension policy

Validate provider claims against the exact service tier and region.
```

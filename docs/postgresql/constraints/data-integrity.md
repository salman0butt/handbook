...
description: "Represent impossible states as database errors. Constraints protect every client, migration, script and concurrent transaction."
---
...
Represent impossible states as database errors. Constraints protect every client, migration, script and concurrent transaction.
...
- **Not** — NOT NULL, UNIQUE and primary keys; connect the feature to correctness, execution cost, concurrency and operations.
- **Foreign** — foreign keys and referential actions; connect the feature to correctness, execution cost, concurrency and operations.
- **Check** — CHECK and exclusion constraints; connect the feature to correctness, execution cost, concurrency and operations.
- **Defaults** — defaults and generated columns; connect the feature to correctness, execution cost, concurrency and operations.
- **Deferred** — deferred constraints; connect the feature to correctness, execution cost, concurrency and operations.
- **Constraint** — constraint validation timing; connect the feature to correctness, execution cost, concurrency and operations.
- **Constraint** — constraint naming; connect the feature to correctness, execution cost, concurrency and operations.
- **Database** — database versus application validation; connect the feature to correctness, execution cost, concurrency and operations.
- **Safe** — safe business-rule enforcement; connect the feature to correctness, execution cost, concurrency and operations.

---
title: "PostgreSQL Setup and Tooling"
description: "Own the complete client/server setup path: packages, Docker, psql, GUI clients, connection strings, clusters, configuration files and authentication."
---

# PostgreSQL Setup and Tooling
...
Own the complete client/server setup path: packages, Docker, psql, GUI clients, connection strings, clusters, configuration files and authentication.
...
- **Macos,** — macOS, Linux and Windows installation; connect the feature to correctness, execution cost, concurrency and operations.
- **Docker** — Docker development servers; connect the feature to correctness, execution cost, concurrency and operations.
- **Server** — server versus client tools; connect the feature to correctness, execution cost, concurrency and operations.
- **Psql,** — psql, pgAdmin, DBeaver and TablePlus; connect the feature to correctness, execution cost, concurrency and operations.
- **Connection** — connection URIs and environment variables; connect the feature to correctness, execution cost, concurrency and operations.
- **Ports,** — ports, processes, clusters and data directories; connect the feature to correctness, execution cost, concurrency and operations.
- **Postgresql.conf** — postgresql.conf and pg_hba.conf; connect the feature to correctness, execution cost, concurrency and operations.
- **Local** — local and remote authentication troubleshooting; connect the feature to correctness, execution cost, concurrency and operations.

...
description: "An ORM changes authoring ergonomics, not PostgreSQL semantics. Inspect generated SQL, retain database constraints and keep escape hatches for workload-specific queries."
---
...
An ORM changes authoring ergonomics, not PostgreSQL semantics. Inspect generated SQL, retain database constraints and keep escape hatches for workload-specific queries.
...
- **Prisma,** — Prisma, Drizzle, TypeORM and Sequelize; connect the feature to correctness, execution cost, concurrency and operations.
- **Knex** — Knex and Kysely; connect the feature to correctness, execution cost, concurrency and operations.
- **Raw** — raw SQL; connect the feature to correctness, execution cost, concurrency and operations.
- **Generated** — generated SQL inspection; connect the feature to correctness, execution cost, concurrency and operations.
- **Transactions** — transactions and migrations; connect the feature to correctness, execution cost, concurrency and operations.
- **Relation** — relation loading and N+1; connect the feature to correctness, execution cost, concurrency and operations.
- **Type** — type safety versus runtime validation; connect the feature to correctness, execution cost, concurrency and operations.
- **Database** — database constraints; connect the feature to correctness, execution cost, concurrency and operations.
- **Escape** — escape hatches and abstraction leaks; connect the feature to correctness, execution cost, concurrency and operations.
- **Choosing** — choosing ORM, query builder or handwritten SQL; connect the feature to correctness, execution cost, concurrency and operations.
...
const rows = await db
  ...
  .innerJoin('customers as c', 'c.customer_id', 'o.customer_id')
...
// Log and EXPLAIN the generated SQL for critical paths.
```

---
title: "PostgreSQL with Node.js and TypeScript"
description: "Treat a pool as a bounded shared resource. Keep one client for each transaction, parameterize values and make cancellation, timeouts and shutdown explicit."
---

# PostgreSQL with Node.js and TypeScript
...
Treat a pool as a bounded shared resource. Keep one client for each transaction, parameterize values and make cancellation, timeouts and shutdown explicit.
...
- **Node-postgres** — node-postgres pg; connect the feature to correctness, execution cost, concurrency and operations.
- **Connection** — connection pools; connect the feature to correctness, execution cost, concurrency and operations.
- **Parameterized** — parameterized queries; connect the feature to correctness, execution cost, concurrency and operations.
- **Transactions** — transactions and prepared statements; connect the feature to correctness, execution cost, concurrency and operations.
- **Query** — query cancellation and timeouts; connect the feature to correctness, execution cost, concurrency and operations.
- **Postgresql** — PostgreSQL error handling; connect the feature to correctness, execution cost, concurrency and operations.
- **Numeric,** — numeric, bigint and timestamp mapping; connect the feature to correctness, execution cost, concurrency and operations.
- **Jsonb** — JSONB and arrays; connect the feature to correctness, execution cost, concurrency and operations.
- **Streaming** — streaming and cursor pagination; connect the feature to correctness, execution cost, concurrency and operations.
- **Bulk** — bulk insertion and graceful shutdown; connect the feature to correctness, execution cost, concurrency and operations.
- **Observability** — observability and integration testing; connect the feature to correctness, execution cost, concurrency and operations.

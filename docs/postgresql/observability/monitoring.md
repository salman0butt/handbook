...
description: "Observe demand, saturation, errors and database-specific health together. A single cache-hit ratio or CPU graph cannot explain an incident."
---
...
Observe demand, saturation, errors and database-specific health together. A single cache-hit ratio or CPU graph cannot explain an incident.
...
- **Logs,** — logs, metrics and traces; connect the feature to correctness, execution cost, concurrency and operations.
- **Pg_stat_activity** — pg_stat_activity and pg_stat_statements; connect the feature to correctness, execution cost, concurrency and operations.
- **Database,** — database, table and index sizes; connect the feature to correctness, execution cost, concurrency and operations.
- **Connections** — connections and transaction rate; connect the feature to correctness, execution cost, concurrency and operations.
- **Lock** — lock waits and deadlocks; connect the feature to correctness, execution cost, concurrency and operations.
- **Long-running** — long-running queries; connect the feature to correctness, execution cost, concurrency and operations.
- **Replication** — replication lag; connect the feature to correctness, execution cost, concurrency and operations.
- **Autovacuum** — autovacuum health; connect the feature to correctness, execution cost, concurrency and operations.
- **Checkpoint** — checkpoint and WAL pressure; connect the feature to correctness, execution cost, concurrency and operations.
- **Disk** — disk usage, alerting, dashboards and SLOs; connect the feature to correctness, execution cost, concurrency and operations.
- **Incident** — incident response and safe query termination; connect the feature to correctness, execution cost, concurrency and operations.

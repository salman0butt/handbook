...
description: "Partitioning is data lifecycle and pruning architecture, not a substitute for ordinary indexing. Use it when partitions enable operations or eliminate meaningful work."
---
...
Partitioning is data lifecycle and pruning architecture, not a substitute for ordinary indexing. Use it when partitions enable operations or eliminate meaningful work.
...
- **Range,** — range, list and hash partitioning; connect the feature to correctness, execution cost, concurrency and operations.
- **Subpartitioning** — subpartitioning; connect the feature to correctness, execution cost, concurrency and operations.
- **Partition** — partition keys and pruning; connect the feature to correctness, execution cost, concurrency and operations.
- **Partition-wise** — partition-wise joins and aggregation; connect the feature to correctness, execution cost, concurrency and operations.
- **Partition** — partition indexes and foreign keys; connect the feature to correctness, execution cost, concurrency and operations.
- **Attach** — attach and detach; connect the feature to correctness, execution cost, concurrency and operations.
- **Retention** — retention and time-series use cases; connect the feature to correctness, execution cost, concurrency and operations.
- **Maintenance** — maintenance and migration strategies; connect the feature to correctness, execution cost, concurrency and operations.
- **Common** — common mistakes and when not to partition; connect the feature to correctness, execution cost, concurrency and operations.

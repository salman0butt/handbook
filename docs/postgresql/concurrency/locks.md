...
description: "Locks serialize conflicting actions. Diagnose the blocker and lock mode before terminating anything or adding timeouts."
---
...
Locks serialize conflicting actions. Diagnose the blocker and lock mode before terminating anything or adding timeouts.
...
- **Table** — table and row lock modes; connect the feature to correctness, execution cost, concurrency and operations.
- **Advisory** — advisory locks; connect the feature to correctness, execution cost, concurrency and operations.
- **For** — FOR UPDATE, NO KEY UPDATE, SHARE and KEY SHARE; connect the feature to correctness, execution cost, concurrency and operations.
- **Deadlocks** — deadlocks and lock queues; connect the feature to correctness, execution cost, concurrency and operations.
- **Lock_timeout** — lock_timeout and statement_timeout; connect the feature to correctness, execution cost, concurrency and operations.
- **Detecting** — detecting blockers; connect the feature to correctness, execution cost, concurrency and operations.
- **Safe** — safe session termination; connect the feature to correctness, execution cost, concurrency and operations.
- **High-contention** — high-contention design; connect the feature to correctness, execution cost, concurrency and operations.
- **Skip** — SKIP LOCKED job queues and idempotency; connect the feature to correctness, execution cost, concurrency and operations.

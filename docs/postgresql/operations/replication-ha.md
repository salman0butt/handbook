...
description: "Replication copies data; high availability coordinates health, leadership, routing and recovery. Replication alone does not prevent split brain."
---
...
Replication copies data; high availability coordinates health, leadership, routing and recovery. Replication alone does not prevent split brain.
...
- **Physical** — physical and streaming replication; connect the feature to correctness, execution cost, concurrency and operations.
- **Synchronous** — synchronous and asynchronous commit; connect the feature to correctness, execution cost, concurrency and operations.
- **Replication** — replication slots; connect the feature to correctness, execution cost, concurrency and operations.
- **Hot** — hot standby and read replicas; connect the feature to correctness, execution cost, concurrency and operations.
- **Failover** — failover and switchover; connect the feature to correctness, execution cost, concurrency and operations.
- **Wal** — WAL retention and replica lag; connect the feature to correctness, execution cost, concurrency and operations.
- **Cascading** — cascading replication; connect the feature to correctness, execution cost, concurrency and operations.
- **Logical** — logical publications and subscriptions; connect the feature to correctness, execution cost, concurrency and operations.
- **Conflict** — conflict handling and upgrade paths; connect the feature to correctness, execution cost, concurrency and operations.
- **Connection** — connection routing and managed-service differences; connect the feature to correctness, execution cost, concurrency and operations.

---
title: "Vacuum, Analyze and Storage Internals"
description: "Heap pages keep tuple versions until vacuum can reclaim them. WAL protects durability; checkpoints bound recovery work; autovacuum protects space and transaction ID safety."
---

# Vacuum, Analyze and Storage Internals
...
Heap pages keep tuple versions until vacuum can reclaim them. WAL protects durability; checkpoints bound recovery work; autovacuum protects space and transaction ID safety.
...
- **Pages,** — pages, tuples and heap storage; connect the feature to correctness, execution cost, concurrency and operations.
- **Toast** — TOAST; connect the feature to correctness, execution cost, concurrency and operations.
- **Wal** — WAL and checkpoints; connect the feature to correctness, execution cost, concurrency and operations.
- **Dead** — dead tuples; connect the feature to correctness, execution cost, concurrency and operations.
- **Vacuum** — VACUUM and autovacuum; connect the feature to correctness, execution cost, concurrency and operations.
- **Analyze** — ANALYZE and statistics; connect the feature to correctness, execution cost, concurrency and operations.
- **Freezing** — freezing and XID wraparound; connect the feature to correctness, execution cost, concurrency and operations.
- **Visibility** — visibility and free-space maps; connect the feature to correctness, execution cost, concurrency and operations.
- **Hot** — HOT updates, fillfactor and bloat; connect the feature to correctness, execution cost, concurrency and operations.
- **Storage** — storage monitoring and safe maintenance; connect the feature to correctness, execution cost, concurrency and operations.

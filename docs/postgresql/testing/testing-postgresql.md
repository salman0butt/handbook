---
title: "Testing PostgreSQL Systems"
description: "Use a real PostgreSQL engine for behavior that depends on SQL, constraints, locks, plans or extensions. Mocks cannot validate database semantics."
---

# Testing PostgreSQL Systems
...
Use a real PostgreSQL engine for behavior that depends on SQL, constraints, locks, plans or extensions. Mocks cannot validate database semantics.
...
- **Sql** — SQL and constraint tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Migration** — migration tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Transaction-based** — transaction-based isolation; connect the feature to correctness, execution cost, concurrency and operations.
- **Disposable** — disposable databases and Docker; connect the feature to correctness, execution cost, concurrency and operations.
- **Testcontainers** — Testcontainers; connect the feature to correctness, execution cost, concurrency and operations.
- **Seed** — seed data, factories and fixtures; connect the feature to correctness, execution cost, concurrency and operations.
- **Integration** — integration and concurrency tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Deadlock** — deadlock and performance tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Plan** — plan regression tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Backup,** — backup, restore, replication and failover tests; connect the feature to correctness, execution cost, concurrency and operations.
- **Production-like** — production-like data distributions; connect the feature to correctness, execution cost, concurrency and operations.

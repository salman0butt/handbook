...
description: "Choose types as executable domain decisions. A type controls accepted values, storage, operators, casts, indexes and application mapping."
---
...
Choose types as executable domain decisions. A type controls accepted values, storage, operators, casts, indexes and application mapping.
...
- **Integer** — integer families and identity columns; connect the feature to correctness, execution cost, concurrency and operations.
- **Numeric** — numeric versus floating point; connect the feature to correctness, execution cost, concurrency and operations.
- **Boolean,** — boolean, text, bytea and character types; connect the feature to correctness, execution cost, concurrency and operations.
- **Date,** — date, time, timestamp, timestamptz and interval; connect the feature to correctness, execution cost, concurrency and operations.
- **Uuid,** — UUID, enum, domain and composite types; connect the feature to correctness, execution cost, concurrency and operations.
- **Arrays,** — arrays, JSON and JSONB; connect the feature to correctness, execution cost, concurrency and operations.
- **Ranges** — ranges and multiranges; connect the feature to correctness, execution cost, concurrency and operations.
- **Network,** — network, geometric, XML and full-text types; connect the feature to correctness, execution cost, concurrency and operations.
- **Type** — type storage, validation and indexing support; connect the feature to correctness, execution cost, concurrency and operations.
...
CREATE TABLE invoices (
  ...
  service_period daterange NOT NULL,

...
description: "Authentication proves an identity; authorization constrains what that role can do. Ownership, search_path and SECURITY DEFINER are part of the attack surface."
---
...
Authentication proves an identity; authorization constrains what that role can do. Ownership, search_path and SECURITY DEFINER are part of the attack surface.
...
- **Roles,** — roles, login and membership; connect the feature to correctness, execution cost, concurrency and operations.
- **Database,** — database, schema, table, sequence and function privileges; connect the feature to correctness, execution cost, concurrency and operations.
- **Default** — default privileges and ownership; connect the feature to correctness, execution cost, concurrency and operations.
- **Security** — SECURITY DEFINER and search_path security; connect the feature to correctness, execution cost, concurrency and operations.
- **Row-level** — row-level security and tenant isolation; connect the feature to correctness, execution cost, concurrency and operations.
- **Scram** — SCRAM and TLS; connect the feature to correctness, execution cost, concurrency and operations.
- **Least** — least privilege and secrets management; connect the feature to correctness, execution cost, concurrency and operations.
- **Sql** — SQL injection and parameterized queries; connect the feature to correctness, execution cost, concurrency and operations.
- **Audit** — audit logging and sensitive-data handling; connect the feature to correctness, execution cost, concurrency and operations.

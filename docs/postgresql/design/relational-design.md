...
description: "Model durable facts, identities, relationships and invariants before optimizing access paths. Schema design is a correctness boundary."
---
...
Model durable facts, identities, relationships and invariants before optimizing access paths. Schema design is a correctness boundary.
...
- **Entities** — entities and relationships; connect the feature to correctness, execution cost, concurrency and operations.
- **Natural** — natural and surrogate keys; connect the feature to correctness, execution cost, concurrency and operations.
- **One-to-one,** — one-to-one, one-to-many and many-to-many; connect the feature to correctness, execution cost, concurrency and operations.
- **Junction** — junction tables; connect the feature to correctness, execution cost, concurrency and operations.
- **1nf,** — 1NF, 2NF, 3NF and BCNF; connect the feature to correctness, execution cost, concurrency and operations.
- **Denormalization** — denormalization decisions; connect the feature to correctness, execution cost, concurrency and operations.
- **Hierarchical** — hierarchical data models; connect the feature to correctness, execution cost, concurrency and operations.
- **Audit** — audit fields and soft deletion; connect the feature to correctness, execution cost, concurrency and operations.
- **Shared-schema** — shared-schema and schema-per-tenant multi-tenancy; connect the feature to correctness, execution cost, concurrency and operations.
- **Migration-friendly** — migration-friendly naming and ownership; connect the feature to correctness, execution cost, concurrency and operations.

...
description: "A view stores a query interface; a materialized view stores a result snapshot. Choose based on freshness, writeability and operational refresh cost."
---
...
A view stores a query interface; a materialized view stores a result snapshot. Choose based on freshness, writeability and operational refresh cost.
...
- **Standard** — standard and updatable views; connect the feature to correctness, execution cost, concurrency and operations.
- **Security-barrier** — security-barrier views; connect the feature to correctness, execution cost, concurrency and operations.
- **Materialized** — materialized views; connect the feature to correctness, execution cost, concurrency and operations.
- **Normal** — normal and concurrent refresh; connect the feature to correctness, execution cost, concurrency and operations.
- **Unique** — unique indexes for concurrent refresh; connect the feature to correctness, execution cost, concurrency and operations.
- **Permissions** — permissions through views; connect the feature to correctness, execution cost, concurrency and operations.
- **Reporting** — reporting and caching; connect the feature to correctness, execution cost, concurrency and operations.
- **Stale-data** — stale-data trade-offs and migrations; connect the feature to correctness, execution cost, concurrency and operations.
...
CREATE UNIQUE INDEX daily_revenue_day_uq

---
title: "Query Planning and EXPLAIN"
description: "The planner estimates cardinalities and costs, then chooses a plan. Read plans from execution nodes, loops and row counts rather than from indentation alone."
---
...
The planner estimates cardinalities and costs, then chooses a plan. Read plans from execution nodes, loops and row counts rather than from indentation alone.
...
- **Planner** — planner cost model and statistics; connect the feature to correctness, execution cost, concurrency and operations.
- **Sequential,** — sequential, index, index-only and bitmap scans; connect the feature to correctness, execution cost, concurrency and operations.
- **Nested** — nested loop, hash and merge joins; connect the feature to correctness, execution cost, concurrency and operations.
- **Sort** — sort and aggregation strategies; connect the feature to correctness, execution cost, concurrency and operations.
- **Parallel** — parallel plans; connect the feature to correctness, execution cost, concurrency and operations.
- **Explain** — EXPLAIN and EXPLAIN ANALYZE; connect the feature to correctness, execution cost, concurrency and operations.
- **Buffers,** — buffers, WAL, memory and timing; connect the feature to correctness, execution cost, concurrency and operations.
- **Misestimation** — misestimation and extended statistics; connect the feature to correctness, execution cost, concurrency and operations.
- **Prepared** — prepared statements and generic versus custom plans; connect the feature to correctness, execution cost, concurrency and operations.

...
description: "A join combines row sets according to a predicate. Correctness depends on cardinality, null-extension and whether duplicate matches are expected."
---
...
A join combines row sets according to a predicate. Correctness depends on cardinality, null-extension and whether duplicate matches are expected.
...
- **Inner,** — inner, left, right, full and cross joins; connect the feature to correctness, execution cost, concurrency and operations.
- **Self** — self and lateral joins; connect the feature to correctness, execution cost, concurrency and operations.
- **Semi-join** — semi-join and anti-join patterns; connect the feature to correctness, execution cost, concurrency and operations.
- **Correlated** — correlated subqueries; connect the feature to correctness, execution cost, concurrency and operations.
- **Exists,** — EXISTS, IN and NOT EXISTS; connect the feature to correctness, execution cost, concurrency and operations.
- **Union,** — UNION, UNION ALL, INTERSECT and EXCEPT; connect the feature to correctness, execution cost, concurrency and operations.
- **Duplicate** — duplicate rows and accidental Cartesian products; connect the feature to correctness, execution cost, concurrency and operations.
- **Join** — join selectivity and performance; connect the feature to correctness, execution cost, concurrency and operations.

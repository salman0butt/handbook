...
description: "Use subqueries and CTEs to name intermediate relations. Understand when PostgreSQL can inline a CTE and when materialization changes work."
---
...
Use subqueries and CTEs to name intermediate relations. Understand when PostgreSQL can inline a CTE and when materialization changes work.
...
- **Scalar** — scalar and table subqueries; connect the feature to correctness, execution cost, concurrency and operations.
- **Correlated** — correlated subqueries; connect the feature to correctness, execution cost, concurrency and operations.
- **Common** — common table expressions; connect the feature to correctness, execution cost, concurrency and operations.
- **Writable** — writable CTEs; connect the feature to correctness, execution cost, concurrency and operations.
- **Materialized** — MATERIALIZED and NOT MATERIALIZED; connect the feature to correctness, execution cost, concurrency and operations.
- **Recursive** — recursive CTEs; connect the feature to correctness, execution cost, concurrency and operations.
- **Tree** — tree and graph traversal; connect the feature to correctness, execution cost, concurrency and operations.
- **Sequence** — sequence generation and cycle detection; connect the feature to correctness, execution cost, concurrency and operations.
- **Readability** — readability versus performance; connect the feature to correctness, execution cost, concurrency and operations.

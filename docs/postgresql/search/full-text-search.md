...
description: "Full-text search normalizes language-aware lexemes into tsvector values and matches them with tsquery expressions."
---
...
Full-text search normalizes language-aware lexemes into tsvector values and matches them with tsquery expressions.
...
- **Tsvector** — tsvector and tsquery; connect the feature to correctness, execution cost, concurrency and operations.
- **Parsers,** — parsers, dictionaries and configurations; connect the feature to correctness, execution cost, concurrency and operations.
- **Tokenization** — tokenization and normalization; connect the feature to correctness, execution cost, concurrency and operations.
- **Ranking** — ranking and highlighting; connect the feature to correctness, execution cost, concurrency and operations.
- **Generated** — generated search columns; connect the feature to correctness, execution cost, concurrency and operations.
- **Gin** — GIN and GiST indexes; connect the feature to correctness, execution cost, concurrency and operations.
- **Prefix** — prefix and phrase search; connect the feature to correctness, execution cost, concurrency and operations.
- **Multilingual** — multilingual search; connect the feature to correctness, execution cost, concurrency and operations.
- **Typo-tolerance** — typo-tolerance limitations and external search trade-offs; connect the feature to correctness, execution cost, concurrency and operations.

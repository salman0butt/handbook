---
title: "Geospatial PostgreSQL with PostGIS"
description: "PostGIS is an extension, not core PostgreSQL. Choose geometry or geography deliberately and keep coordinate reference systems explicit."
---
...
PostGIS is an extension, not core PostgreSQL. Choose geometry or geography deliberately and keep coordinate reference systems explicit.
...
- **Enabling** — enabling extensions; connect the feature to correctness, execution cost, concurrency and operations.
- **Geometry** — geometry versus geography; connect the feature to correctness, execution cost, concurrency and operations.
- **Srids** — SRIDs; connect the feature to correctness, execution cost, concurrency and operations.
- **Points,** — points, lines and polygons; connect the feature to correctness, execution cost, concurrency and operations.
- **Distance** — distance and containment; connect the feature to correctness, execution cost, concurrency and operations.
- **Nearby-location** — nearby-location search; connect the feature to correctness, execution cost, concurrency and operations.
- **Gist** — GiST spatial indexes; connect the feature to correctness, execution cost, concurrency and operations.
- **Coordinate** — coordinate systems and GeoJSON; connect the feature to correctness, execution cost, concurrency and operations.
- **Application** — application integration and coordinate mistakes; connect the feature to correctness, execution cost, concurrency and operations.

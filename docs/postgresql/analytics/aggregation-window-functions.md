---
title: "Aggregation and Analytics SQL"
description: "Aggregation collapses groups; window functions preserve detail while calculating across a defined partition and frame."
---
...
Aggregation collapses groups; window functions preserve detail while calculating across a defined partition and frame.
...
- **Aggregate** — aggregate functions, GROUP BY and HAVING; connect the feature to correctness, execution cost, concurrency and operations.
- **Conditional** — conditional aggregation; connect the feature to correctness, execution cost, concurrency and operations.
- **Grouping** — grouping sets, rollup and cube; connect the feature to correctness, execution cost, concurrency and operations.
- **Window** — window partitions, ordering and frames; connect the feature to correctness, execution cost, concurrency and operations.
- **Ranking,** — ranking, running totals and moving averages; connect the feature to correctness, execution cost, concurrency and operations.
- **Lag,** — lag, lead and percentiles; connect the feature to correctness, execution cost, concurrency and operations.
- **Cohort,** — cohort, funnel and retention analysis; connect the feature to correctness, execution cost, concurrency and operations.
- **Time-series** — time-series aggregation; connect the feature to correctness, execution cost, concurrency and operations.

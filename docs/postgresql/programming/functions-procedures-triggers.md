...
description: "Database code runs close to data and can enforce cross-client invariants, but hidden side effects and row-by-row work can become operational liabilities."
---
...
Database code runs close to data and can enforce cross-client invariants, but hidden side effects and row-by-row work can become operational liabilities.
...
- **Sql** — SQL and PL/pgSQL functions; connect the feature to correctness, execution cost, concurrency and operations.
- **Parameters** — parameters and return types; connect the feature to correctness, execution cost, concurrency and operations.
- **Set-returning** — set-returning functions; connect the feature to correctness, execution cost, concurrency and operations.
- **Immutable,** — immutable, stable and volatile volatility; connect the feature to correctness, execution cost, concurrency and operations.
- **Stored** — stored procedures; connect the feature to correctness, execution cost, concurrency and operations.
- **Row** — row and statement triggers; connect the feature to correctness, execution cost, concurrency and operations.
- **Before,** — before, after and transition-table triggers; connect the feature to correctness, execution cost, concurrency and operations.
- **Audit** — audit and validation triggers; connect the feature to correctness, execution cost, concurrency and operations.
- **Recursion** — recursion and performance risks; connect the feature to correctness, execution cost, concurrency and operations.
